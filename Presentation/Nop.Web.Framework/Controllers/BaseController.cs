...
namespace Nop.Web.Framework.Controllers
{
    ...
    public abstract class BaseController : Controller
    {
        ...
        public virtual IOrganizationService InitCRM()
        {


            CrmServiceClient crmConn = new CrmServiceClient("AuthType=Office365;Url=https://mohammedsalahcrm.crm4.dynamics.com;"
              + "Username=MohammedSalah19@mohammedsalahcrm.OnMicrosoft.com;Password=Mo01112754765;");
